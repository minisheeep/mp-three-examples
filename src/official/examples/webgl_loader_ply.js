...
const exampleInfo = {
  ...
  info: [
    [
      ...
      { tag: 'text', content: '- PLY loader test by' }
    ],
    [
      { tag: 'a', link: 'https://github.com/menway', content: 'Wei Meng' },
      { tag: 'text', content: '.' },
      { tag: 'text', content: 'Image from' },
      {
        tag: 'a',
        link: 'http://people.sc.fsu.edu/~jburkardt/data/ply/ply.html',
        content: 'John Burkardt'
      }
    ]
  ],
