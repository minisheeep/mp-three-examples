...
const exampleInfo = {
  ...
  info: [
    [
      ...
      { tag: 'text', content: '- color lines' }
    ],
    [
      { tag: 'a', link: 'http://en.wikipedia.org/wiki/Hilbert_curve', content: 'Hilbert curve' },
      { tag: 'text', content: 'thanks to' },
      { tag: 'a', link: 'https://openprocessing.org/user/5654', content: 'Thomas Diewald' }
    ]
  ],
