...
const exampleInfo = {
  ...
  useLoaders: [KTXLoader],
  info: [
    [
      { tag: 'a', link: 'https://threejs.org', content: 'three.js' },
      { tag: 'text', content: '- webgl - compressed KTX textures' }
    ],
    [
      {
        tag: 'a',
        link: 'https://www.khronos.org/opengles/sdk/tools/KTX/file_format_spec/',
        content: 'Khronos Texture'
      },
      { tag: 'text', content: 'is a lightweight file format for OpenGL' }
    ]
  ],
