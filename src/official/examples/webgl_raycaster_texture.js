...
const exampleInfo = {
  ...
  init: ({
    ...
    function CanvasTexture(parentTexture) {
      ...
      this._background.src = withCDNPrefix('textures/uv_grid_opengl.jpg');
    ...
    function init() {
      ...
      circleTexture = new THREE.Texture(
        undefined,
        THREE.UVMapping,
        THREE.RepeatWrapping,
        THREE.RepeatWrapping
      ...
      rendererCanvas.addEventListener('pointermove', onMouseMove);
    ...
    function onMouseMove(evt) {
      ...
      const array = getMousePosition(rendererCanvas, evt.clientX, evt.clientY);
