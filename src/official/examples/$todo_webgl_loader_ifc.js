...
const exampleInfo = {
  ...
  info: [
    [
      ...
      { tag: 'text', content: '- See' }
    ],
    [
      {
        tag: 'a',
        link: 'https://github.com/ThatOpen',
        content: 'main project repository'
      },
      { tag: 'text', content: 'for more information and BIM tools.' }
    ]
  ],
  init: ({ window, canvas, GUI, Stats, autoDispose, useFrame }) => {
